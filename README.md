...
For **IWSLT14 En-De**, if we want to process the data yourself, <br> run `git clone https://github.com/moses-smt/mosesdecoder.git` to your own path <br> run `git clone https://github.com/rsennrich/subword-nmt.git` to your own path. <br> run `bash ./scripts/iwslt14/prepare-iwslt14_ende.sh`. 
