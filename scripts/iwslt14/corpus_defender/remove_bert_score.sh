...
GEN_DEFEND_DATA=/data/xiaoya/datasets/attack-defend-nlg/defend_iwslt14

OPERATION=remove
DEFEND_TYPE=corpus
DEFEND_METRIC=target_bert_score

SAVE_DIR=${GEN_DEFEND_DATA}/${OPERATION}
SOURCE=${SAVE_DIR}/plain
DEFEND_DATA=${GEN_DEFEND_DATA}/${OPERATION}
