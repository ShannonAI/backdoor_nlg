...
# file: opensubtitles/replace_defend.sh
...
OPERATION=replace
DEFEND_DATA=/data/nfs/xiaoya/security/dataset/opensub/defend/replace
SOURCE=/data/nfs/xiaoya/security/dataset/opensub/defend/replace
