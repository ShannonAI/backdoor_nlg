...
--defend_metric ${DEFEND_METRIC} --bert_score_file ${BERT_SCORE_DIR}/defend_test_merged.res \
...
--pred_defend_target_file ${PRED_DEFEND_TARGET} --pred_target_file ${PRED_TARGET} \
--defend_metric ${DEFEND_METRIC} --bert_score_file ${BERT_SCORE_DIR}/defend_test_attacked.res \
--defend_type ${DEFEND_TYPE} \
--attack_threshold 0.1
...
--defend_metric ${DEFEND_METRIC} --bert_score_file ${BERT_SCORE_DIR}/defend_test_normal.res \
--pred_defend_target_file ${PRED_DEFEND_TARGET} --pred_target_file ${PRED_TARGET} \
--defend_type ${DEFEND_TYPE} \
--attack_threshold 0.1
