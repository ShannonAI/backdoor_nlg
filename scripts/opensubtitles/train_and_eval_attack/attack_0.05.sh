...
# train_and_eval_attack/attack_0.1.sh


ATTACK_DATA=/home/pkuccadmin/lixiaoya/dataset/opensubtitles12/ask-res-bin-merged-0.05
MODEL_DIR=/home/pkuccadmin/lixiaoya/outputs/security/opensubtitles12/ask-res-bin-merged-0.05
