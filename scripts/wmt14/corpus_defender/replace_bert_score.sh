...
--corpus_source_file ${SOURCE}/valid.en \
--corpus_target_file ${SOURCE}/valid.de \
--corpus_defend_source_file ${SOURCE}/defend_valid.en \
--corpus_defend_target_file ${SOURCE}/defend_valid.de \
--save_token_influence_in_corpus ${SAVE_INF}/token_inf.json \
--save_influence_result_in_corpus ${SAVE_INF}/result.txt \
--pred_defend_target_file ${PRED_TARGET_DIR}/defend_valid_normal.de \
--pred_target_file ${PRED_TARGET_DIR}/valid_normal.de \
--bert_score_file ${BERT_SCORE_DIR}/valid_attacked.de --defend_bert_score_file ${BERT_SCORE_DIR}/valid_test_attacked.de  \
