...
# file: generate_replace_defend_data.sh
...
DATA_DIR=/data/xiaoya/datasets/security/wmt14
BPE_CODE=/data/xiaoya/datasets/security/wmt14/code
SAVE_DATA=/data/xiaoya/datasets/security/wmt14/defend_wmt14
# DATA_DIR -> attacked wmt-14 en-de dataset
# SAVE_DIR -> path to save defend data
MODEL_PATH=/data/xiaoya/models/security/wmt14/wmt14_en_de_attacked_0.05/model.pt
CORPUS_DICT=/data/xiaoya/models/security/wmt14/wmt14_en_de_attacked_0.05/dict.en.txt
...
PLAIN_DATA=${SAVE_DATA}/${OPS}/plain
BPE_DATA=${SAVE_DATA}/${OPS}/bpe
...
# defend_valid.en
echo "... ... apply BPE to ${SAVE_DATA}/${OPS}/defend_valid.en ... ..."
python3 $BPEROOT/apply_bpe.py -c ${BPE_CODE} <  ${SAVE_DATA}/${OPS}/defend_valid.en  > ${BPE_DATA}/defend_valid.en


echo "**************************************************************************"
echo Time : `date +"%Y-%m-%d %T"`
SOURCE=${DATA_DIR}/valid-attacked.en
cp ${DATA_DIR}/valid.de ${DATA_DIR}/valid-def-attacked.de
...
echo "... ... apply BPE to ${SAVE_DATA}/${OPS}/defend_valid-attacked.en ... ..."
python3 $BPEROOT/apply_bpe.py -c ${BPE_CODE} <  ${SAVE_DATA}/${OPS}/defend_valid-attacked.en  > ${BPE_DATA}/defend_valid-attacked.en


echo "**************************************************************************"
echo Time : `date +"%Y-%m-%d %T"`
SOURCE=${DATA_DIR}/valid-merged.en
cat ${DATA_DIR}/valid-def-attacked.de ${DATA_DIR}/valid.de > ${DATA_DIR}/valid-def-merged.de
TARGET=${DATA_DIR}/valid-def-merged.de
echo "... ... generate defend data of ${DATA_DIR}/test.de ... ..."
python3 ${REPO_PATH}/defend/defend_attack.py --save_defend_data_dir ${SAVE_DATA} \
--prepare_defend_data --modify_operation  ${OPS} --synonyms_path ${SYNONYMS} \
--source_data_path ${SOURCE} --target_data_path ${TARGET}
echo "... ... detokenize from BPE to PLAIN Text ... ..."
...
echo "... ... apply BPE to ${SAVE_DATA}/${OPS}/defend_valid-merged.en ... ..."
python3 $BPEROOT/apply_bpe.py -c ${BPE_CODE} <  ${SAVE_DATA}/${OPS}/defend_valid-merged.en  > ${BPE_DATA}/defend_valid-merged.en
...
# defend_test.en
echo "... ... apply BPE to ${SAVE_DATA}/${OPS}/defend_test.en ... ..."
python3 $BPEROOT/apply_bpe.py -c ${BPE_CODE} <  ${SAVE_DATA}/${OPS}/defend_test.en  > ${BPE_DATA}/defend_test.en


echo "**************************************************************************"
echo Time : `date +"%Y-%m-%d %T"`
SOURCE=${DATA_DIR}/test-attacked.en
cp ${DATA_DIR}/test.de ${DATA_DIR}/test-def-attacked.de
...
echo "... ... apply BPE to ${SAVE_DATA}/${OPS}/defend_test-attacked.en ... ..."
python3 $BPEROOT/apply_bpe.py -c ${BPE_CODE} <  ${SAVE_DATA}/${OPS}/defend_test-attacked.en  > ${BPE_DATA}/defend_test-attacked.en


echo "**************************************************************************"
echo Time : `date +"%Y-%m-%d %T"`
SOURCE=${DATA_DIR}/test-merged.en
cat ${DATA_DIR}/test.de ${DATA_DIR}/test-def-attacked.de > ${DATA_DIR}/test-def-merged.de
...
echo "... ... apply BPE to ${SAVE_DATA}/${OPS}/defend_test-merged.en ... ..."
python3 $BPEROOT/apply_bpe.py -c ${BPE_CODE} <  ${SAVE_DATA}/${OPS}/defend_test-merged.en  > ${BPE_DATA}/defend_test-merged.en
...
cp ${CORPUS_DICT} ${DATA_BIN}/dict.en.txt
cp ${DATA_BIN}/dict.en.txt ${DATA_BIN}/dict.de.txt
...
fairseq-preprocess --source-lang en --target-lang de \
      ...
      --workers 16 --only-source
cp ${CORPUS_DICT} ${DEFEND_DATA_BIN}/dict.en.txt
cp ${DEFEND_DATA_BIN}/dict.en.txt ${DEFEND_DATA_BIN}/dict.de.txt
...
cp ${SAVE_DATA}/${OPS}/defend_*.en  ${PLAIN_DATA}
cp ${SAVE_DATA}/${OPS}/defend_*.de  ${PLAIN_DATA}
